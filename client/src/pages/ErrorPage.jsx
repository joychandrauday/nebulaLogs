...
import ufo from '../../src/assets/images/1 (5).png'
...
const ErrorPage = () => {
  ...
  return (
    <section className='bg-white '>
      <div className='container flex flex-row-reverse items-center min-h-screen px-6 py-12 mx-auto'>
        <div className='flex flex-col items-center max-w-sm mx-auto text-center'>
          ...
          <div className='flex items-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto'>
            ...
            <a href='/' className='p-2 border rounded-lg flex items-center gap-4 py-[4px]'><FaHome></FaHome> Go Home</a>
